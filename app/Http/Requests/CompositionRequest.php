...
class CompositionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'client.birth_date' => ['required', 'date' , 'before_or_equal:'.Carbon::now()->toDateString()],
            ...
            'beneficiaries.*.birth_date' => ['required', 'date' , 'before_or_equal:'.Carbon::now()->toDateString()],
            ...
            'father.birth_date' => ['required', 'date' , 'before_or_equal:'.Carbon::now()->toDateString()],
            ...
            'mother.birth_date' => ['required', 'date' , 'before_or_equal:'.Carbon::now()->toDateString()],
