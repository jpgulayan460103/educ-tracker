...
class CompositionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'father.last_name' => ['string', 'max:255', new ValidStringName, new BioParentExist],
            'father.first_name' => ['string', 'max:255', new ValidStringName],
            ...
            'mother.last_name' => ['string', 'max:255', new ValidStringName, new BioParentExist],
            'mother.first_name' => ['string', 'max:255', new ValidStringName],
